...
sampleRate, signal = wavfile.read("hauteur.wav")
...
def freqToMel(freq):
    return 1127.01048 * numpy.log(1 + freq / 700.0)

def melToFreq(mel):
    return 700 * (numpy.exp(freq / 1127.01048 - 1))

complexSpectrum = scipy.fftpack.fft(signal)
powerSpectrum = abs(complexSpectrum) ** 2
filteredSpectrum = numpy.dot(powerSpectrum, melFilterBank(8))
