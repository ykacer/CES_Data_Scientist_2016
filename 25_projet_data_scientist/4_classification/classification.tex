...
Régression & > 1\\
\hline 
Régression Ridge ($\lambda=1000$) & ~ 1 \\
\hline 
Régression Lasso ($\lambda=100$) & 0.960 \\
\hline 
Régression ElasticNet ($\lambda=10,l=0.75$) & 0.963 \\
\hline
Support Vector Régression à noyau gaussien & ~1 \\
\hline
Réseau de neurones régressif & 0.822\\
\hline
For\^{e}t d'arbres aléatoires régressifs & 0.4926\\
\hline
