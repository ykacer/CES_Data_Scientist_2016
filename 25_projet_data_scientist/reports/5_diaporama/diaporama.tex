...
\begin{itemize}
 ...
 \item Cross-validated (stratified 3-folds) gamma coefficient ($\gamma = 0.01$)
\end{itemize}
\end{frame}
\begin{frame}
\begin{columns}
...
\begin{itemize}
 ...
 \begin{itemize}
  ...
  \item Early stopping activation to avoid overfitting (i.e. stop iterative training when no more decrease in validation error)
 \end{itemize}
\end{frame}
