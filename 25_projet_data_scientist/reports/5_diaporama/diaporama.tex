...
\begin{overlayarea}{\linewidth}{1cm}
  \centering
  \scriptsize 68 resulting datasets georeferenced in \begin{ishape}Web Mercator\end{itshape} system\par
\end{overlayarea}
\end{column}
\end{columns}
...
{\scriptsize
 ...
 \begin{columns}
  ...
  \begin{overlayarea}{\linewidth}{1cm}
    \centering
    \tiny Switzerland datasets georeferenced in \begin{ishape}Web Mercator\end{itshape} system\par
  \end{overlayarea}
  \end{column}
  \begin{column}{0.33\textwidth}
   \begin{overlayarea}{\linewidth}{3cm}
  ...
  \begin{overlayarea}{\linewidth}{1cm}
    \centering
    \tiny Belgium datasets georeferenced in \begin{ishape}Web Mercator\end{itshape} system\par
  \end{overlayarea}
  \end{column}
  \begin{column}{0.33\textwidth}
  \begin{overlayarea}{\linewidth}{3cm}
  ...
  \begin{overlayarea}{\linewidth}{1cm}
    \centering
    \tiny Netherlands datasets georeferenced in \begin{ishape}Web Mercator\end{itshape} system\par
  \end{overlayarea}
  \end{column}
 \end{columns}
}
