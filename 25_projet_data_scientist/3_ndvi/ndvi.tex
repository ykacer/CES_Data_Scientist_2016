...
\begin{itemize}
 \item communes densément peuplées : $Lyon$ ($10117$habs/km\textsuperscript{2}), $Montpellier$ ($4524$habs/km\textsuperscript{2}) et $Perpignan$ ($1724$habs/km\textsuperscript{2}).
 \item communes de densité intermédiaire : $
\end{itemize}
