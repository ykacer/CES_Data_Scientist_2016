 ...
 * landat-8_gdal-processing : bash file that pre-preprocess a ~1Gb typical Landast-8 dataset creating channels combination(Credit to :[*Dan Stahlke*](https://github.com/gina-alaska/dans-gdal-scripts))
